 ...
 *
 * CodeMirror に触るモジュール（language / theme / remote-cursors / code-editor-view）は
 * ここから export しない。export すると副作用ごとサーバのバンドルに入る（docs/bundle.md）。
 */
...
export { ProposalPanel } from './proposal-panel.tsx'
