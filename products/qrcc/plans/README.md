...
| 007  | 種類を増やしたときに壊れる 4 つの switch を、増やしても壊れない形にする                             | P1       | S      | 002        | TODO    |
| 003  | 設計済みで未実装の内容の種類（名刺・メール・電話・SMS・地図・予定）を実装する                       | P1       | M      | 002, 007   | BLOCKED |
| 004  | 読めるのに作れない 1D バーコード（Code 39 / Code 93 / EAN-8 / ITF / Codabar）を生成できるようにする | P1       | M      | 002, 007   | BLOCKED |
